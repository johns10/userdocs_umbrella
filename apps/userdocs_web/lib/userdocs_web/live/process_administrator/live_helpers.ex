defmodule UserDocsWeb.ProcessAdministratorLive.LiveHelpers do
  alias UserDocsWeb

  alias UserDocsWeb.ProcessAdministratorLive.CollapsableFormComponent
  alias UserDocsWeb.ProcessAdministratorLive.GroupComponent
  alias UserDocsWeb.ProcessAdministratorLive.EmbeddedFormComponent
  alias UserDocsWeb.ProcessAdministratorLive.NestedFormComponent
  alias UserDocsWeb.ProcessAdministratorLive.VersionPicker
  alias UserDocsWeb.ProcessAdministratorLive.ModalMenus
  alias UserDocsWeb.ProcessAdministratorLive.ModalComponent
  ...
  def level(socket, opts) do
    UserDocsWeb.ProcessAdministratorLive.LevelComponent.render(opts)
  end
