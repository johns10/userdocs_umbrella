defmodule UserDocsWeb.ProcessAdministratorLive.ContentVersionLive.FormComponent do
  ...
  def render_fields(assigns) do
    ~L"""
      ...
      <%= f = form_for @changeset, "#",
        ...
        <%= UserDocsWeb.ProcessAdministratorLive.ContentVersionLive.FormComponent.render_fields(assigns, f) %>
