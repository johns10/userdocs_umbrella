defmodule UserdocsWeb.LiveViewPowHelper do
  @moduledoc """
  ...
  def maybe_assign_current_user(socket, pid, %{"userdocs_web_auth" => _signed_token} = session, pow_config, renewal_config) do
  ...
  defp verify_token(socket, %{"userdocs_web_auth" => signed_token}, pow_config) do
