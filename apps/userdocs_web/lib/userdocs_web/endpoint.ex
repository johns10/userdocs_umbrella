defmodule UserDocsWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :userdocs_web
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :userdocs_web
  end
