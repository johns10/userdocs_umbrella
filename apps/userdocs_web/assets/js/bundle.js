  ...
  return function (e) {
    ...
    var b = function (e) {
      return function (t, n, i) {
        ...
        var _ = t,
            D = _.nodeType,
            N = n.nodeType;
        if (!A) if (D === f) N === f ? l(t, n) || (x(t), _ = function (e, t) {
        ...
        if (_ === n) x(t);else {
          ...
          if (I(_, n, A), S) for (var O = 0, R = S.length; O < R; O++) {
            var H = C[S[O]];
            H && L(H, H.parentNode, !1);
          }
        }
        return !A && _ !== t && t.parentNode && (_.actualize && (_ = _.actualize(t.ownerDocument || a)), t.parentNode.replaceChild(_, t)), _;
      };
    }(function (e, t) {
      var n,
          i,
    ...
    var $ = function (e, t, n, i) {
      ...
      function e(t, n) {
        ...
        this.socket = new n(t, r), this.bindingPrefix = r.bindingPrefix || q, this.opts = r, this.params = z(r.params || {}), this.viewLogger = r.viewLogger, this.metadataCallbacks = r.metadata || {}, this.defaults = Object.assign(X(W), r.defaults || {}), this.activeElement = null, this.prevActive = null, this.silenced = !1, this.main = null, this.linkRef = 0, this.roots = {}, this.href = window.location.href, this.pendingLink = null, this.currentLocation = X(window.location), this.hooks = r.hooks || {}, this.loaderTimeout = r.loaderTimeout || V, this.boundTopLevelEvents = !1, this.domCallbacks = r.dom || {
          onBeforeElUpdated: z()
      ...
      undoRefs: function (e, t) {
        re.all(t, "[".concat(M, '="').concat(e, '"]'), function (e) {
      ...
      syncPendingRef: function (e, t) {
        var n = e.getAttribute(M);
        return null === n || (H.forEach(function (n) {
          e.classList.contains(n) && t.classList.add(n);
        }), t.setAttribute(M, n), !re.isFormInput(e) && !/submit/i.test(e.type));
      }
    },
        oe = function () {
      ...
      return P(e, [{
        ...
        value: function () {
          ...
          if (!this.isCIDPatch() || o) {
            ...
            return this.trackBefore("added", i), this.trackBefore("updated", i, i), n.time("morphdom", function () {
              b(o, g, {
                ...
                onNodeAdded: function (n) {
                  re.isNowTriggerFormExternal(n, h) && n.submit(), re.isPhxChild(n) && t.ownsElement(n) && e.trackAfter("phxChildAdded", n), f.push(n);
                },
                onNodeDiscarded: function (t) {
                  re.isPhxChild(t) && n.destroyViewByEl(t), e.trackAfter("discarded", t);
                },
                onBeforeNodeDiscarded: function (t) {
                  return !(!t.getAttribute || null === t.getAttribute("data-phx-remove")) || (null === t.parentNode || !re.isPhxUpdate(t.parentNode, l, ["append", "prepend"])) && !e.skipCIDSibling(t) && (e.trackBefore("discarded", t), !0);
                },
                onElUpdated: function (e) {
                  re.isNowTriggerFormExternal(e, h) && e.submit(), v.push(e);
                },
                onBeforeElUpdated: function (t, n) {
                  if (e.skipCIDSibling(n)) return !1;
                  if ("ignore" === t.getAttribute(l)) return e.trackBefore("updated", t, n), re.mergeAttrs(t, n), v.push(t), !1;
                  if ("number" === t.type && t.validity && t.validity.badInput) return !1;
                  if (!re.syncPendingRef(t, n)) return !1;
                  ...
                  if (re.copyPrivates(n, t), re.discardError(o, n, d), a && t.isSameNode(a) && re.isFormInput(t) && !e.forceFocusedSelectUpdate(t, n)) return e.trackBefore("updated", t, n), re.mergeFocusedInput(t, n), re.syncAttrsToProps(t), v.push(t), !1;

                  if (re.isPhxUpdate(n, l, ["append", "prepend"])) {
                  ...
                  return re.syncAttrsToProps(n), e.trackBefore("updated", t, n), !0;
                }
              });
              ...
              p.forEach(function (e) {
                ...
                "append" === r.getAttribute(l) ? i.reverse().forEach(function (e) {
                  Z(document.getElementById(e), function (e) {
            ...
            }), re.dispatchEvent(document, "phx:update"), f.forEach(function (t) {
      ...
      return P(e, [{
        ...
        value: function (e, t) {
          ...
          return e.after("added", function (e) {
            ...
            n.liveSocket.triggerDOM("onBeforeElUpdated", [e, t]);
            var i = n.getHook(e),
                r = i && "ignore" === e.getAttribute(n.binding("update"));
            !i || e.isEqualNode(t) || r && function (e, t) {
              return JSON.stringify(e) === JSON.stringify(t);
            }(e.dataset, t.dataset) || (o.add(e.id), i.__trigger__("beforeUpdate"));
          }), e.after("updated", function (e) {
            var t = n.getHook(e);
            t && o.has(e.id) && t.__trigger__("updated");
        ...
        key: "addHook",
        value: function (e) {
          if (!ce.elementID(e) && e.getAttribute) {
            ...
            if (!t || this.ownsElement(e)) {
              ...
              if (n) {
                var i = new ce(this, e, n);
                return this.viewHooks[ce.elementID(i.el)] = i, i;
              }
        ...
        key: "destroyHook",
        value: function (e) {
          e.__trigger__("destroyed"), e.__cleanup__(), delete this.viewHooks[ce.elementID(e.el)];
        }
      }, {
        ...
        value: function (e, t, n) {
          ...
          return u && null !== u.getAttribute(this.binding("page-loading")) && (c = this.liveSocket.withPageLoading({
            ...
            return i.channel.push(t, n, 3e4).receive("ok", function (e) {
              var t = null;
              null !== a && re.undoRefs(a, i.el), e.diff && (t = i.applyDiff("update", e.diff, function (e) {
                var t = e.diff,
                    n = e.events;
                i.update(t, n);
...
Hooks.jobRunner = {
  mounted: function mounted() {
    ...
    this.handleEvent("message", function (payload) {
      ...
      _this2.pushEventTo('#' + e.detail.element_id, "update_status", payload);
    });
  }
};
Hooks.executeStep = {
  mounted: function mounted() {
    ...
    this.el.addEventListener("click", function (e) {
      ...
      _this3.pushEventTo('#' + e.detail.element_id, "update_job_status", payload);
    });
  }
};
Hooks.CopySelector = {
...
xhr.onload = function (e) {
  ...
  var liveSocket = new phoenix_live_view__WEBPACK_IMPORTED_MODULE_4__["LiveSocket"]("ws://localhost:4000/live", phoenix__WEBPACK_IMPORTED_MODULE_2__["Socket"], {
    params: {
