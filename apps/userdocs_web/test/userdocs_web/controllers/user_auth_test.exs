defmodule UserDocsWeb.UserAuthTest do
  use UserDocsWeb.ConnCase, async: true

  alias UserDocs.Auth
  alias UserDocsWeb.UserAuth
  import UserDocs.AuthFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, UserDocsWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      UserDocsWeb.Endpoint.subscribe(live_socket_id)
