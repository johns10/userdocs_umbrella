defmodule UserDocs.Automation.Step do
  ...
  # |> change content
    ...
    |> maybe_replace_content_params(last_change)
  ...
  def maybe_replace_page_params(changeset, %{ changes: %{ page_id: page_id }}) do
    IO.puts("Replacing Page #{page_id} Params")
    page = changeset.data.page
  ...
  def maybe_replace_page_params(changeset, _last_changeset), do: changeset
  ...
  def maybe_replace_annotation_params(changeset, %{ changes: %{ annotation_id: annotation_id }}) do
    IO.puts("Replacing Annotation #{annotation_id} Params")
    annotation = changeset.data.annotation
  ...
  def maybe_replace_annotation_params(changeset, _last_changeset), do: changeset
  ...
  def maybe_replace_element_params(changeset, %{ changes: %{ element_id: element_id }}) do
    IO.puts("Replacing params")
    element = changeset.data.element
  ...
  def maybe_replace_element_params(changeset, _last_changeset), do: changeset
  ...
  def maybe_replace_content_params(changeset, %{ changes: %{ annotation: %{ changes: %{ content_id: nil }}}}), do: changeset
  def maybe_replace_content_params(
    changeset, %{ changes: %{ annotation: %{ changes: %{ content_id: content_id }}}}
  ) do
    IO.inspect("Replace COntent Params")
    content = changeset |> Map.get(:data) |> Map.get(:annotation) |> Map.get(:content)
  ...
  def maybe_replace_content_params(changeset, _last_changeset), do: changeset
