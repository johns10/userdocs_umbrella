defmodule UserDocs.AutomationManager do
  ...
  def get_step_preloads(query) do
    ...
    |> preload([page: page, version: v, project: p], [page: {page, version: {v, project: p}}])
  ...
  def get_process!(id) do
    ...
    |> preload([steps: s, page: page, version: v, project: p], [steps: {s, page: {page, version: {v, project: p}}}])
