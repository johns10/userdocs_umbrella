defmodule ProcessAdministratorWeb.LiveViewPowHelper do
  @moduledoc """
  ...
  defmacro __using__(_opts) do
    ...
    pow_config  = [otp_app: :process_administrator_web, backend: Pow.Store.Backend.MnesiaCache]
  ...
  def maybe_assign_current_user(socket, pid, %{"process_administrator_web_auth" => _signed_token} = session, pow_config, renewal_config) do
  ...
  defp verify_token(socket, %{"process_administrator_web_auth" => signed_token}, pow_config) do
